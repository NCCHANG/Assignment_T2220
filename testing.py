...
def main():
    ...
    while gameRunning:
        player2, storeIndex = selectColumn(storeIndex,randomNum,GRIDSIZE,True,player1,player2)
        columnNum(GRIDSIZE)
        ...
        player1, storeIndex = selectRow(storeIndex,randomNum,GRIDSIZE,True,player1,player2)
        currentColumn(storeIndex,GRIDSIZE)
        layout(storeIndex,randomNum,GRIDSIZE,False)
        printScore(GRIDSIZE,player1,player2)
        gameRunning = checkColumn(randomNum,GRIDSIZE,gameRunning)
...
def selectColumn(index,list,size,row,p1,p2):
    while True:
...
def selectRow(index,list,size,row,p1,p2):
    while True:
